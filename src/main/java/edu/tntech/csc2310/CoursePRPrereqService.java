//Written by Jerry Gannod, comments written by Jerry Gannod
...
public class CoursePRPrereqService {
     ...
     * @return
     */
    private ArrayList<HashMap<String, String>> GenerateAdjacencyList(String prefix) throws CatalogNotFoundException {
