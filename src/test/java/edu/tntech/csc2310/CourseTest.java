...
public class CourseTest {
    ...
    @Test
    public void getFalseSubject() throws IOException {
        try {
            data = new Course("KAS", "1010", "202180");
            assertEquals("Subject", "KAS", data.getSubject());
    ...
    //written by Kasandra Chavez
    @Test
    public void getFalseNumber() throws IOException {
        try{
            data = new Course("CSC", "0001", "202180");
            assertEquals("Subject", "0001", data.getNumber());
    ...
    //written by Kasandra Chavez
    @Test
    public void getFalseTitle() throws IOException {
        try {
            data = new Course("CSC", "1300", "202180");
            assertNotEquals("Title", "Programming for Babies", data.getTitle());
